...
export default function NewsEventsPage() {
  ...
  const allItems = [
    ...
    },
    {
      id: 4,
      type: "news",
      title: "Alumni Donates $1M for Scholarships",
      date: "2023-05-03",
      eventDate: new Date(2023, 4, 3),
      excerpt:
        "Successful graduate establishes endowment fund for underprivileged students.",
      image:
    ...
    // Regular event items
    {
      ...
      date: "2023-06-12",
      eventDate: new Date(2023, 5, 12),
      time: "4:00 PM - 7:00 PM",
      location: "Classrooms",
      excerpt:
        "Opportunity to discuss your child's progress with their teachers.",
      image:
        "https://images.unsplash.com/photo-1571260898930-9d9c2b9df79c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1374&q=80",
      category: "Academics",
    },
    {
      id: 6,
      ...
      date: "2023-06-25",
      eventDate: new Date(2023, 5, 25),
      time: "10:00 AM",
      location: "Football Field",
      excerpt:
        "Celebrating our graduating class with keynote speaker Dr. Jane Smith.",
      image:
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto">
          ...
          {viewMode === "calendar" ? (
            ...
            /* Grid View - Shows both news and events */
            <AnimatePresence>
                  ...
                  {filteredItems.map((item) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        >
                          {item.type === "news" ? "Read more" : "Event details"}
